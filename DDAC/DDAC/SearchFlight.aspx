<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchFlight.aspx.cs" Inherits="DDAC.SearchFlight" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h2 class="text-center">Search Flight</h2>

    <div>
    <asp:DropDownList ID="Origin" runat="server">
    ...
    &nbsp;
         <asp:DropDownList ID="selectDestination" runat="server">
                           <asp:ListItem value="" selected="selected">(please select a country)</asp:ListItem>
                           <asp:ListItem value="AF">Afghanistan</asp:ListItem>
                           <asp:ListItem value="AL">Albania</asp:ListItem>
                           <asp:ListItem value="DZ">Algeria</asp:ListItem>
   ...
   <asp:TextBox ID="txtDatePicker" runat="server" ReadOnly = "true"></asp:TextBox>
...
&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server"  AutoGenerateSelectButton="true" OnSelectedIndexChanged="rowselectclick" >
